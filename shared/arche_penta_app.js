...
(function () {
  ...
  var CSS = ""
    ...
    + ".pnta-ov{position:fixed;inset:0;background:rgba(8,11,46,.55);z-index:2147483000;overflow-y:auto;-webkit-overflow-scrolling:touch;padding:24px 12px;font-family:'Noto Sans KR',sans-serif}"
    ...
    + ".apw.track,.apw.vision{display:block!important;height:auto!important;overflow:visible!important;background:transparent!important;border-radius:0!important;position:static!important}"
